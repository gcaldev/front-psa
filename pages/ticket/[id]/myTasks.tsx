...
function buscarNombredeProyecto(
  projects: Proyecto[] | null | undefined,
  ...
  const proyectoEncontrado = projects.find(
    (proyecto) => parseInt(proyecto.id, 10) === parseInt(proyectoId, 10)
  );
...
export default function TaskswithTicket() {
  ...
  return (
    <div className="flex-1">
      ...
      <h2 className="text-1xl font-bold mt-2">al ticket: {thisTicket?.nombre}</h2>
      ...
      >
        <div className="grid grid-cols-2 px-2 py-2 mt-2 border border-black p-4">
          ...
          <p className="mb-5">
            {buscarNombredeProyecto(proyectos, selectedTask?.projectId)}
          </p>
      ...
      >
        <div className="flex flex-col">
          <div className="border border-black p-4 mt-2">
            ...
            <p className="mb-5">
              Esta acción no se puede deshacer. Por favor, confirme su decisión
              antes de proceder.
            </p>
          </div>
